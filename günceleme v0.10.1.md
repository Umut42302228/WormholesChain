# Wormholes güncellemesi (v.10.1)

## Kurulum için servis dosyası oluşturuyoruz aşağıdaki kodu yazıyoruz ( Daha önce oluşturanlar bu kısmı atlayabilir )
```
...
## Node bloklarını izlemek için sunucumuzda bir isim vererek bu dosyayı kayıt ediyoruz. Aşağıdaki şekilde komutu çalıştırarak kaçıncı blokta olduğumuzu görebiliyoruz.
Örnek ; 
```
bash ./monitor.sh 
```
